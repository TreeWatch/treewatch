...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Main Part of the Report
    ...
    \section{Improve mobile development skills}
    
    I choose this learning goal, since I always wanted to learn more about app programming. I strongly look for a future career app development, since this is a really interesting and fast moving field. Since our project consists of creating a app for our customer, this was a great opportunity to improve my knowledge about app development. 
...
\begin{STAR}
    ...
    I also worked together with René Karoff on the KML part of our application. This was done to load real data from our customer in the app. For this we created a kml-parser as seen in the project dossier chapter 15 section 42. This allowed us to read in real data about the field from fleuren, like the different blocks, the field boundaries or heat maps.
...
\section{Improve knowledge about Test Driven Development}
I choose this learning goal since Test Driven Development is a really good way to improve the quality of your code and catch bugs early. Also it helps to stop regression bugs introduced through refactoring. I also learned how bad it is to not use any form of automated testing during my internship project.
...
\section{Improve communication of ideas}
I choose this learning goal since I always have problems communicating clearly enough so other people get the ideas I want to present to them. Also i wated  
