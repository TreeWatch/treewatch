...
\begin{STAR}
    ...
    I also worked together with René Karoff on the KML part of our application. This was done to load real data from our cutomer in the app. For this we created a kml-parser as seen in CODEREF-KMLParser. This allowed us to read in real data about the field from fleuren, like the different blocks, the field boundaries or heat maps.
