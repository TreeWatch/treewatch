...
\addcontentsline{toc}{section}{Document information}
  ...
  \textbf{Scrum}\\
  The SCRUM plan was not created by the SCRUM master and is therefor not included in this document.
    
  \textbf{Final presentation}\\
  This chapter contains the slides of the final presentation so that future groups can use the same style when presenting.
  ...
  \chapter{Geofence classdiagram}
  \addPart{parts/designdocuments/geofencediagram.pdf}

  \chapter{Entity relationshipdiagram}
