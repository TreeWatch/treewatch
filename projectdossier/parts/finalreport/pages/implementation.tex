...
\gls{kml} files. \gls{kml} is basically just a version of \gls{xml} which is designed for geospatial data. To convert the files we used 
...
\begin{figure}
	\begin{tikzpicture}
			...
			\begin{interface}[text width=5cm]{IGeofence}{0,0}
			...
			\begin{interface}[text width=5cm]{IGeofenceStore}{11,0}
			...
			\begin{interface}[text width=5cm]{IGeofenceListener}{5.5,0}
