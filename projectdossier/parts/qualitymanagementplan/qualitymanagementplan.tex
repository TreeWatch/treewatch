...
\begin{table}[htbp]
	\begin{tabularx}{\textwidth}{ l *{3}{X} }
		\textbf{Editor} & \textbf{Date} & \textbf{Note} & \textbf{Status} \\
		\hline
		Rene Karoff & \printdate{2015-09-04} & Initial & Draft \\
		Max van der Linden & \printdate{2015-09-04} & Review & Draft\\
		Rene Karoff & \printdate{2015-09-24} & Update & Draft\\
		Rene Karoff & \printdate{2015-10-02} & Update & v0.1\\
		Max van der Linden & \printdate{2015-10-02} & Review & v0.1\\
		Rene Karoff & \printdate{2015-10-16} & Update & v0.2\\
		Rene Karoff & \printdate{2015-11-13} & Update & v0.3\\
		Rene Karoff & \printdate{2015-12-10} & Update & Final\\
		Max van der Linden & \printdate{2015-12-10} & Review & Final\\
	\end{tabularx}
\end{table}
\listoffigures
...
\end{tabularx}
\captionof{table}{Group roles\label{tab:GroupRoles}}
...
\end{description}
		...
		\begin{figure}[htpb]
			\centering
			\includegraphics[width=.98\linewidth,keepaspectratio=true,angle=90]{./img/CheckQuality.png}
